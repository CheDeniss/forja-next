            ...
            <div className={styles.wrapper}>
                ...
                {status === "success" && (
                    <>
                        ...
                        <p className={styles.info}>This window will close automatically in {countdown} seconds.</p>
                ...
                {status === "error" && (
                    <>
                        ...
                        <p className={styles.info}>
                            Having trouble verifying your email? Create a support ticket, and we'll help you out!
                        </p>
                        <CustomButtonOther onClick={() => window.open("/faq#email-confirmation", "_blank")}>
                            Open FAQ
                        </CustomButtonOther>
                    </>
                )}
